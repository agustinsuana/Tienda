...
/**
 * Tienda\OfertaBundle\Entity\Oferta
 *
 * @ORM\Table()
 * @ORM\Entity
 */
class Oferta
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Tienda\TiendaBundle\Entity\Tienda")
     */
    private $tienda;
     ...
     * @param string $tienda
     */
    public function setTienda(\Tienda\TiendaBundle\Entity\Tienda $tienda)
    {
        $this->tienda = $tienda;
    }
